    ...
    <div className="min-h-screen bg-gray-50 pb-24 pt-8 px-4 font-sans">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-[2rem] shadow-xl p-8 text-center border border-gray-100 mb-8">
          <div className="w-24 h-24 bg-wine-yellow rounded-full mx-auto mb-4 flex items-center justify-center text-4xl shadow-inner">
            🍷
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
              <p className="text-gray-400 text-[10px] font-bold uppercase">Livello</p>
              <p className="text-2xl font-black text-gray-800">{profile?.current_level || 1}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
              <p className="text-gray-400 text-[10px] font-bold uppercase">Punti</p>
              <p className="text-2xl font-black text-gray-800">{profile?.total_score || 0}</p>
            </div>
          </div>
